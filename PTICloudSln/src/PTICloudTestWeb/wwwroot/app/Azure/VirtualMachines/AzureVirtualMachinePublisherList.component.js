...
var AzureVirtualMachinePublisherListComponent = (function () {
    function AzureVirtualMachinePublisherListComponent(_azureVMsService, router, route) {
        this._azureVMsService = _azureVMsService;
        this.router = router;
        this.route = route;
    }
    AzureVirtualMachinePublisherListComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AzureVirtualMachinePublisherListComponent = __decorate([
        core_1.Component({
    ...
    return AzureVirtualMachinePublisherListComponent;
}());
exports.AzureVirtualMachinePublisherListComponent = AzureVirtualMachinePublisherListComponent;
//# sourceMappingURL=AzureVirtualMachinePublisherList.component.js.map